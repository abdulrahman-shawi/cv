...
const sections = [
  ...
  { key: "blog", label: "المقالات", description: "منشورات المدونة", href: "/admin/blog", ready: true },
  { key: "contact", label: "تواصل معي", description: "بيانات التواصل ونصوص النموذج", href: "/admin/contact", ready: true },
];
